...
$sql = "SELECT id, username, page FROM likes where page='LalBagh.php'";
...
<h1 align="center" style="margin-top: 10px;"> Lal Bagh </h1>
...
<a href="https://www.google.co.in/maps/place/Lalbagh+Botanical+Garden/@12.9507432,77.5825886,17z/data=!3m1!4b1!4m5!3m4!1s0x3bae15c191f2d31d:0x8e110b99df2fbe22!8m2!3d12.9507432!4d77.5847773"><button class="like">G Maps</button></a>
<a href="https://www.google.co.in/search?q=Lalbagh&source=lnms&tbm=isch&sa=X&ved=0ahUKEwj--fqfwK_XAhWKqI8KHTqpB-MQ_AUICygC&biw=1536&bih=758"><button class="dislike">Google Images</button></a>
</div>
<div class="content2">
<p class="content">Lalbagh or Lalbagh Botanical Gardens, meaning The Red Garden in English, is a well known botanical garden in southern Bengaluru, India. The garden was originally commissioned by Hyder Ali, the ruler of Mysore, and later finished by his son Tipu Sultan.[1] It has a famous glass house which hosts two annual flower shows (26 January and 15 August). Lalbagh houses India's largest collection of tropical plants, has a lake, and is one of the main tourist attractions in Bengaluru.[2] Lal Bagh is also home to a few species of birds. The commonly sighted birds include Myna, Parakeets, Crows, Brahminy Kite, Pond Heron, Common Egret, Purple Moor Hen etc.</p></div>
<script type="text/javascript">
    var l=0;
    var dl=0;
    function like(x){
