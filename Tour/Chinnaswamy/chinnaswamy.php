...
$sql = "SELECT id, username, page FROM likes where page='chinnaswamy.php'";
...
<h1 align="center" style="margin-top: 10px;"> M Chinnaswamy Stadium </h1>
