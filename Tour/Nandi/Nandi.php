...
$sql = "SELECT id, username, page FROM likes where page='Nandi.php'";
...
<h1 align="center" style="margin-top: 10px;"> Nandi Hills </h1>
...
<a href="https://www.google.co.in/maps/place/Nandi+Hills,+Karnataka/@13.3828894,77.6515072,14z/data=!3m1!4b1!4m5!3m4!1s0x3bb1e445ebfcea17:0x1639f72959196608!8m2!3d13.370154!4d77.6834551"><button class="like">G Maps</button></a>
<a href="https://www.google.co.in/search?q=Nandi+hills&source=lnms&tbm=isch&sa=X&ved=0ahUKEwimofepxa_XAhUCYo8KHXl8BKgQ_AUICygC&biw=1536&bih=758#imgrc=_"><button class="dislike">Google Images</button></a>
</div>
<div class="content2">
<p class="content">Nandi Hills or Nandi betta (Anglicised forms include Nandidurg and Nandydoorg) is an ancient hill fortress in southern India, in the Chikkaballapur district of Karnataka state. It is 10 km from Chickballapur town and approximately 60 km from the city of Bengaluru. The hills are nestled near the town of Nandi. In traditional belief, the hills are the origin of the Arkavathy river.</p></div>
<script type="text/javascript">
    var l=0;
    var dl=0;
    function like(x){
