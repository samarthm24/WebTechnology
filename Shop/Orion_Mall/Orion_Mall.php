...
$sql = "SELECT id, username, page FROM likes where page='Orion_Mall.php'";
...
<h1 align="center" style="margin-top: 10px;"> Orion Mall </h1>
<div class="w3-content w3-display-container" style="height: 600px;width: 700px;float: left;position: relative;left: 30px;">
  ...
  <img class="mySlides" src="4.jpg" style="width:100%;height: 80%">
    <img class="mySlides" src="5.jpg" style="width:100%;height: 80%">
...
<a href="https://www.google.co.in/maps/place/Orion+Mall/@13.0108961,77.5528043,17z/data=!4m8!1m2!2m1!1sOrion+Mall,+Rajaji+Nagar,+Bengaluru,+Karnataka!3m4!1s0x3bae1629af0c075f:0x3c984ebd22cd5d54!8m2!3d13.0107881!4d77.5549009"><button class="like">G Maps</button></a>
<a href="https://www.google.co.in/search?rlz=1C1CHBF_enIN719IN719&biw=1396&bih=702&tbm=isch&sa=1&ei=rBgPWua0H4OU0gTc9LuABw&q=orion+mall&oq=orion+ma&gs_l=psy-ab.3.0.0i67k1j0l3j0i67k1j0l5.95370.96821.0.99266.8.8.0.0.0.0.229.1043.0j4j2.6.0....0...1.1.64.psy-ab..2.6.1039....0.wQnT-kl-uhY"><button class="dislike">Google Images</button></a>
</div>
<div class="content2">
<p class="content">Orion Mall is a shopping Mall at Brigade Gateway Enclave in Bangalore, Karnataka, India developed by Brigade Group. Orion mall with a total mall area of 1.1 million sqft is the 3rd largest mall in Bangalore. Orion Mall is part of a premium integrated enclave known as Brigade Gateway which houses World Trade Center, Sheraton Grand Hotel,Columbia Asia Hospital apart from the mall in its premises. Orion mall has 4 floors of retail space which includes shopping zones, multiplex, Food & Dining including lakeside cafes and bowling & gaming zones, 11-screen, 2,800-seat capacity apart from 144 seat gold class screens PVR Cinemas multiplex, BluO - the 27-lane bowling centre, Time Zone an 8000 sq-ft gaming zone.</p></div>
