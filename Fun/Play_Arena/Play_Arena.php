...
$sql = "SELECT id, username, page FROM likes where page='Play_Arena.php'";
...
<h1 align="center" style="margin-top: 10px;"> PlaY Arena </h1>
...
<a href="https://www.google.co.in/maps?rlz=1C1CHBF_enIN719IN719&biw=1396&bih=657&q=play+arena+bangalore&um=1&ie=UTF-8&sa=X&ved=0ahUKEwjE3NrG38jXAhWJwrwKHeIIDeEQ_AUICigB"><button class="like">G Maps</button></a>
<a href="https://www.google.co.in/search?rlz=1C1CHBF_enIN719IN719&biw=1396&bih=657&tbm=isch&sa=1&ei=uHoQWqmTGoP58QWQipr4Cg&q=play+arena+bangalore&oq=play+arena&gs_l=psy-ab.1.1.0l10.66518.68884.0.70286.10.10.0.0.0.0.165.936.0j7.7.0....0...1.1.64.psy-ab..3.7.935....0.aezbyx4R-lU"><button class="dislike">Google Images</button></a>
</div>
<div class="content2">
<p class="content">Remember how easy it was to have fun? All you needed was a bit of space, maybe a ball and before you knew it, you and the kid next door became best friends. Somewhere between work, traffic, malls and smartphones, the city has forgotten the joy of playing. We didn’t. And, honestly, we missed it. That’s why we started Play: a space where you can do just that and in the process, make new friends, play new games, find new adventures — and have some fun while you’re at it. </p></div>
