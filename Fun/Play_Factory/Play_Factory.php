...
$sql = "SELECT id, username, page FROM likes where page='Play_Factory.php'";
...
<h1 align="center" style="margin-top: 10px;"> Play Factory </h1>
...
<a href="https://www.google.co.in/maps?rlz=1C1CHBF_enIN719IN719&biw=1396&bih=657&q=play+factory&um=1&ie=UTF-8&sa=X&ved=0ahUKEwid4-uC4MjXAhXFvbwKHVSbCjQQ_AUICigB"><button class="like">G Maps</button></a>
<a href="https://www.google.co.in/search?rlz=1C1CHBF_enIN719IN719&biw=1396&bih=657&tbm=isch&sa=1&ei=dXsQWuz0CsiQ8gX9iZDQDQ&q=play+factory&oq=play+factory&gs_l=psy-ab.3..0l10.4190.6764.0.7470.12.12.0.0.0.0.159.1417.0j11.11.0....0...1.1.64.psy-ab..1.11.1413...0i67k1.0.wevrz0-lD4o"><button class="dislike">Google Images</button></a>
</div>
<div class="content2">
<p class="content">The facility provides for an International Standard Indoor and Outdoor Active Sports Facility scientifically designed and technically planned to provide for a great experience not only for the competition oriented people but also people who are looking for fitness, fun and work -life balance. </p></div>
