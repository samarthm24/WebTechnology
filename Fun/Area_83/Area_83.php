...
$sql = "SELECT id, username, page FROM likes where page='Area_83.php'";
...
<h1 align="center" style="margin-top: 10px;"> Area 83 </h1>
<div class="w3-content w3-display-container" style="height: 600px;width: 700px;float: left;position: relative;left: 30px;">
  <img class="mySlides" src="1.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
...
<a href="https://www.google.co.in/maps/place/Area+83/@12.8316681,77.5641825,14.22z/data=!4m8!1m2!2m1!1sarea+83+bannerghatta!3m4!1s0x3bae16bb1d961391:0xaffcf6482e71ac0!8m2!3d12.832431!4d77.5690496"><button class="like">G Maps</button></a>
<a href="https://www.google.co.in/search?rlz=1C1CHBF_enIN719IN719&biw=1396&bih=657&tbm=isch&sa=1&ei=N3kQWvn-HsT38QWVrbqICA&q=area+83+bannerghatta&oq=area+83&gs_l=psy-ab.1.2.0l10.87602.89965.0.92614.7.7.0.0.0.0.192.767.0j5.5.0....0...1.1.64.psy-ab..2.5.766...0i67k1.0.ZcRAubWhfq0"><button class="dislike">Google Images</button></a>
</div>
<div class="content2">
<p class="content">Area 83 run by like-minded individuals and adventure thrillists. Our passion is to provide unique and exciting experiences, along with opportunities to relax and unwind.We have a passion for creating outdoor adventures and sharing them with others for lasting memories. We constantly research and dream of the next great adventure that we can add to the list of Area 83 activities to accommodate adventurers of all ages. </p></div>
