...
<h1 align="center"> The Hunan</h1>
<!--  images navigation code starts here  -->
<div margin-top:100px class="w3-content w3-display-container" id="images" style="height: 800px;width: 600px;float: left;position: relative;left: 30px;">
   <img class="mySlides" src="1.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
  <img class="mySlides" src="2.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
  <img class="mySlides" src="3.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
  <img class="mySlides" src="4.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
  <img class="mySlides" src="5.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
  <img class="mySlides" src="6.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
  <img class="mySlides" src="7.png" style="width:100%;height: 80%;box-shadow: 10px 10px #051014;">
...
<!-- <div class="table1"> -->
<a target="_blank" href="hunan/hunan.html">
